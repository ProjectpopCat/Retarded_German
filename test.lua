...
return {
    Notify = function(Properties)
        ...
        if Title or Description then -- Check that user has provided title and/or description
            ...
            Icon.Position = UDim2.new(0, -10, 0.07, 5) -- Position the icon to the left
            ...
            NewLabel.Position = UDim2.new(-1, 20 - IconSize, 0, CalculateBounds(CachedObjects).Y + (Padding * #CachedObjects))
